#pragma checksum "D:\VS_Net2\BookManage\BookManagement\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1793abd620c24c315187ed5e08f2b2387fca239f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1793abd620c24c315187ed5e08f2b2387fca239f", @"/Views/Admin/Index.cshtml")]
        ...
        <div class=""row"">
            <div class=""col-10"" style=""display:none"">
                ...
                <select name=""ValuePage"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1793abd620c24c315187ed5e08f2b2387fca239f5924", async() => {
                WriteLiteral("10");
            }
            );
            ...
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1793abd620c24c315187ed5e08f2b2387fca239f7099", async() => {
                WriteLiteral("20");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1793abd620c24c315187ed5e08f2b2387fca239f8274", async() => {
                WriteLiteral("30");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1793abd620c24c315187ed5e08f2b2387fca239f9449", async() => {
                WriteLiteral("40");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1793abd620c24c315187ed5e08f2b2387fca239f10719", async() => {
...
<script>
                ...
                WriteLiteral(@"ass=""text-center"">Không có dữ liệu.</td></tr>';
                        ...
                        for (var i = 0; i < response.data.length; i++) {
                            ...
                            if ($Item.isActive)
                                ...
                                str = '<button type=""button"" class=""btn btn-primary btn-sm btnConfirm"" data-id=""' + $Item.userID + '""><i class=""fa fa-check-square-o"">&nbsp;Kích hoạt</i></button>';
                            htmlContent += '<tr>' +
                                '<td class=""text-center"">' + (i + 1) + '</td>' +
                              ");
                WriteLiteral(@"  '<td class=""text-center"">' + ($Item.userName || '') + '</td>' +
                                '<td class=""text-center"">' + ($Item.email || '') + '</td>' +
                                '<td class=""text-center"">' + str + '</td>' +
                                '<td class=""text-center"">' +
                                    '<button type=""button"" class=""btn btn-secondary btn-sm btnEdit"" style=""margin-right: 5px;"" data-id=""' + $Item.userID + '""><i class=""fa fa-pencil-square-o"">&nbsp;Sửa</i></button>' +
                        ...
                        $danhmuc.$thisPage.find('table#TBLDANHSACH tbody').html(htmlContent);
                        $('.c");
                WriteLiteral(@"ountItem').text(response.data.length);
                        $danhmuc.DeleteClick();
                        $danhmuc.EditClick();
    ...
    ");
          ...
          ");
                WriteLiteral(@"      $('.btnDelete').off('click').on('click', function () {
                    let id = $(this).data('id');
                    if (id > 0) {
                        $.confirm({
                            ...
                            buttons: {
                                OK: {
                                    ...
                                    action: function () {
                                        ...
                                        var getRespo");
                WriteLiteral(@"nse = AjaxConfig.sendRequestToServer(""Admin/Delete"", ""GET"", dataSend);
                ...
                $('.btnConfirm').off('click').on('click', function () {
                    ...
                    if (id > 0) {
                        ...
                        getResponse.then(function (response) {
                            if (response.header.msgType == BoxType.Success) {
                                $danhmuc.LoadDanhSach(1);
                                $msgDialog.confirm(response.header.msgType, null, response.descrip");
                WriteLiteral(@"tion, null, null, null);
                            }
                            else {
                                $msgDialog.confirm(response.header.msgType, null, response.description, null, null, null);
                            }
     ...
     ");
                WriteLiteral(@"       CloseModal: function () {
            ...
            CreateOrUpdate: function () {
                $('#CreateOrUpdateModal .btnSave').off('click').on('click', function () {
                    ...
                    if (dataSend) {
                        ...
                        let url = (id == 0 || id == """") ? ""/Admin/Ad");
                WriteLiteral(@"dNew"" : ""/Admin/Update"";
