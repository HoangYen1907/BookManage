#pragma checksum "D:\VS_Net2\BookManage\BookManagement\Views\Admin\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a86d8789d4816828fe1a0adfe8a0a17f98efdb66"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a86d8789d4816828fe1a0adfe8a0a17f98efdb66", @"/Views/Admin/Index.cshtml")]
        ...
        <div class=""row"">
            <div class=""col-9"" style=""display:none"">
                ...
                <select name=""ValuePage"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a86d8789d4816828fe1a0adfe8a0a17f98efdb665923", async() => {
                WriteLiteral("10");
            }
            );
            ...
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a86d8789d4816828fe1a0adfe8a0a17f98efdb667098", async() => {
                WriteLiteral("20");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a86d8789d4816828fe1a0adfe8a0a17f98efdb668273", async() => {
                WriteLiteral("30");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a86d8789d4816828fe1a0adfe8a0a17f98efdb669448", async() => {
                WriteLiteral("40");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a86d8789d4816828fe1a0adfe8a0a17f98efdb6610718", async() => {
    ...
    <div class=""modal-dialog  modal-lg"" role=""document"">
        <div class=""modal-content"">");
            ...
            WriteLiteral(@">
                ...
                <div");
            BeginWriteAttribute("class", " class=\"", 3149, "\"", 3157, 0);
            EndWriteAttribute();
...
<script>
    ...
    $(document).ready(function () { //Sau khi load xong html
        ...
        var $danhmuc = {
            ...
            Edit");
                ...
                $('.btnEdit').off('click').on('click', function () {
                   ...
                   ");
                WriteLiteral(@"             $msgDialog.confirm(""orange"", null, ""Thông tin yêu cầu không hợp lệ"", null, null, null);
                            }
                        }).catch(function (xhr) {
                            AjaxConfig.CatchError(xhr);
                        });
                                    ...
                                    action: function () {
                                        ...
                                        getResponse.then(function (response) {
                                            if (response.header.msgType == BoxType.Success) {
                                                ...
                                                $msgDialog.confirm(response.header.m");
                WriteLiteral(@"sgType, null, response.description, null, null, null);
                                            }
                                        }).catch(function (xhr) {
                                            AjaxConfig.CatchError(xhr);
                                        });
            ...
            ConfirmClick: function () {
                $('.btnConfirm').off('click').on('click', function () {
                    ...
                    if (id > 0) {
                        let dataSend = { ""id"": id };
                        var ge");
                WriteLiteral(@"tResponse = AjaxConfig.sendRequestToServer(""Admin/Confirm"", ""GET"", dataSend);
                        getResponse.then(function (response) {
                            if (response.header.msgType == BoxType.Success) {
                                $danhmuc.LoadDanhSach(1);
                                $msgDialog.confirm(response.header.msgType, null, response.description, null, null, null);
        ...
        var $updateModal = {
            ...
            ");
                WriteLiteral(@"    $updateModal.CreateOrUpdate();
            },
            OpenModal: function () {
                    ...
                    if (dataSend) {
                        ...
                        getResponse.then(function (response) {
                            if (response.header.msgType == BoxType.Success) {
                                ...
                                $msgD");
                WriteLiteral(@"ialog.confirm(response.header.msgType, null, response.description, null, null, null);
                            }
                        }).catch(function (xhr) {
                            AjaxConfig.CatchError(xhr);
                        });
