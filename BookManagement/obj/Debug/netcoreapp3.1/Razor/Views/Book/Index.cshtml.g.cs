#pragma checksum "D:\VS_Net2\BookManage\BookManagement\Views\Book\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "615251bb04a8d7d7b23a550b73fa260f5891b9bc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"615251bb04a8d7d7b23a550b73fa260f5891b9bc", @"/Views/Book/Index.cshtml")]
        ...
        <div class=""row"">
            <div class=""col-10"" style=""display:none"">
                ...
                <select name=""ValuePage"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "615251bb04a8d7d7b23a550b73fa260f5891b9bc6362", async() => {
                WriteLiteral("10");
            }
            );
            ...
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "615251bb04a8d7d7b23a550b73fa260f5891b9bc7537", async() => {
                WriteLiteral("20");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "615251bb04a8d7d7b23a550b73fa260f5891b9bc8712", async() => {
                WriteLiteral("30");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "615251bb04a8d7d7b23a550b73fa260f5891b9bc9887", async() => {
                WriteLiteral("40");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "615251bb04a8d7d7b23a550b73fa260f5891b9bc11157", async() => {
                ...
                WriteLiteral(@") {
                            ...
                            getResponse.then(function (response) {
                                if (response.header.msgType == BoxType.Success) {
                                  ...
                                  ");
                WriteLiteral(@"      $('img[name=Avatar]').parent().css('display', 'block');
                                    }
                ...
                LoadDanhSachChapter: function (bookId) {
                    ...
                    getResponse.then(function (response) {
                        if (response.header.msgType == BoxType.Success) {
                            ...
                            response.data = response.data || [];
                            if (response.data.length == 0) {
                                htmlContent = '<tr><td colspan=""10"" class=""text-center"">Không có dữ liệ");
                WriteLiteral(@"u.</td></tr>';
                            ...
                            for (var i = 0; i < response.data.length; i++) {
                                ...
                                htmlContent += '<tr>' +
                                    ...
                                    '<button type=""but");
                WriteLiteral(@"ton"" class=""btn btn-secondary btn-sm btnEditChapter"" style=""margin-right: 5px;"" data-id=""' + $Item.chapterId + '""><i class=""fa fa-pencil-square-o"">&nbsp;Sửa</i></button>' +
                    ...
                    $('.btnEditChapter').off('click').on('click', function () {
                        ...
                        if (id > 0) {
                            ...
                            getResponse.then(function (response) {
                                if (response.header.msgType == BoxType.Success) {
                                    let item = response.data;
                                    $updateChapterModal.Self.");
                WriteLiteral(@"find('input[name=ChapterId]').val(item.chapterId);
            ...
            var $updateChapterModal = {
                ...
                OpenModal: function () {
                    $updateChapterModal.Self.on('shown.bs.modal', function () {
                        let id = ($updateChapterModal.Self.find('input[nam");
                WriteLiteral(@"e=ChapterId]').val() || 0);
                        if (id == 0) {
                ...
                Create");
                WriteLiteral(@"OrUpdate: function () {
                        ...
                        if (dataSend) {
                            ...
                            getResponse.then(function (response) {
                                if (response.header.msgType == BoxType.Success) {
                                    ...
                                    $msgDialog.confirm(response.header.msgType, null, response.description, null, null, null);
");
                WriteLiteral(@"                                    $updateChapterModal.Self.modal('hide');
                                }
                                else {
                                    $msgDialog.confirm(response.header.msgType, null, response.description, null, null, null);
                                }
