#pragma checksum "D:\VS_Net2\BookManage\BookManagement\Views\Book\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "13e44c9ce089119e788d1df7af02fd1e2d88ebe2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"13e44c9ce089119e788d1df7af02fd1e2d88ebe2", @"/Views/Book/Index.cshtml")]
        ...
        <div class=""row"">
            <div class=""col-10"" style=""display:none"">
                ...
                <select name=""ValuePage"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "13e44c9ce089119e788d1df7af02fd1e2d88ebe26362", async() => {
                WriteLiteral("10");
            }
            );
            ...
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "13e44c9ce089119e788d1df7af02fd1e2d88ebe27537", async() => {
                WriteLiteral("20");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "13e44c9ce089119e788d1df7af02fd1e2d88ebe28712", async() => {
                WriteLiteral("30");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "13e44c9ce089119e788d1df7af02fd1e2d88ebe29887", async() => {
                WriteLiteral("40");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "13e44c9ce089119e788d1df7af02fd1e2d88ebe211157", async() => {
...
");
            ...
            var $danhmuc = {
               ...
               ");
                WriteLiteral(@"                     '<td class=""text-center"">' +
                            ...
                            $danhmuc.$thisPage.find('table#TBLDANHSACH tbody').html(htmlContent);
        ");
                WriteLiteral(@"                    $('.countItem').text(response.data.length);
                            $danhmuc.DeleteClick();
                            $danhmuc.EditClick();
                ...
                EditClick: function () {
                    $('.btnEdit').off('click').on('click', function () {
                        ...
                        if (id > 0) {
                            let dataSend = { ""id"": id };
                         ");
                WriteLiteral(@"   var getResponse = AjaxConfig.sendRequestToServer(""Book/GetBook"", ""GET"", dataSend);
  ...
  ");
      ...
      ");
                WriteLiteral(@"              $modal.find('textarea').val("""");
                        ...
                        if (dataSend) {
                            ...
                            getResponse.then(function (response) {
                                if (response.header.msgType == BoxType.Success) {
                                    ...
                                    $msgDialog");
                WriteLiteral(@".confirm(response.header.msgType, null, response.description, null, null, null);
                                }
                            }).catch(function (xhr) {
                                AjaxConfig.CatchError(xhr);
                            });
                ...
                FileChange: function () {
                    $modal.find('input[type=file]').on('change', function () {
                        ...
                        if (file) {
                            ...
                            $('img[name=Avatar]').attr('src', '#');
                            $('img[name=Avatar]').parent().css('display");
                WriteLiteral(@"', 'none');
                        }
                    })
                }
                    ...
                    getResponse.then(function (response) {
                        if (response.header.msgType == BoxType.Success) {
                            ...
                            if (response.data.length == 0) {
                                ...
                                $chapterModal.Self.find('table#TBLDANHSA");
                WriteLiteral(@"CHCHAPTER tbody').html(htmlContent);
                                $('.countItem').text(response.data.length);
                                $('.pagination-page').html('');
                            ...
                            for (var i = 0; i < response.data.length; i++) {
                                ...
                                htmlContent += '<tr>' +
                                    ...
                                    '<button type=""button"" class=""btn btn-secondary btn-sm btnEditChapter"" style=""margin-right: 5px;"" data-id=");
                WriteLiteral(@"""' + $Item.chapterId + '""><i class=""fa fa-pencil-square-o"">&nbsp;Sửa</i></button>' +
                            ...
                            $msgDialog.confirm(response.header.msgType, null, response.body.description, null, null,");
                WriteLiteral(@" null);
                        }
                    }).catch(function (xhr) {
                        AjaxConfig.CatchError(xhr);
       ...
       ");
                WriteLiteral(@"                             $updateChapterModal.Self.find('[name=Content]').val(item.content);
                ...
                DeleteClick: function () {
                    $('.btnDeleteChapter').off('click').on('click', function () {
                        ...
                        if (id > 0) {
                            $.confirm({
                                title: 'XÁC NHẬN THÔNG TIN',
                                content: ""Bạn có chắc chắn muốn xóa khôn");
                WriteLiteral(@"g?"",
                                type: 'orange',
                                typeAnimated: true,
                                columnClass: 'col-md-6 col-md-offset-0',
                                    ...
                                    OK: {
                                        ...
                                        action: function () {
                                            ...
                                            getResponse.then(function (response) {
                                                if (response.header.msgType == BoxType.Success) {
                                 ");
                WriteLiteral(@"                   let bookId = $chapterModal.Self.find('input[name=BookId]').val();
            ...
            var $updateChapterModal = {
                ...
                CreateOrUpdate: function () {
                    $updateChapterModal.Self.find('.btnSaveChapter').off('click').on('click', function () {
                        let dataSend = $up");
                WriteLiteral(@"dateChapterModal.LoadDataSend();
                        if (dataSend) {
                            let id = ($updateChapterModal.Self.find('input[name=ChapterId]').val() || 0);
