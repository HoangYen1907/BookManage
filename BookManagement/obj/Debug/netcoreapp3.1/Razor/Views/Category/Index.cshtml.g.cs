#pragma checksum "D:\VS_Net2\BookManage\BookManagement\Views\Category\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5cd89023b5301eb84d8ddd0cf328e7607af4b3be"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5cd89023b5301eb84d8ddd0cf328e7607af4b3be", @"/Views/Category/Index.cshtml")]
    ...
    public class Views_Category_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\VS_Net2\BookManage\BookManagement\Views\Category\Index.cshtml"
        ...
        <div class=""row"">
            <div class=""col-10"" style=""display:none"">
                ...
                <select name=""ValuePage"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5cd89023b5301eb84d8ddd0cf328e7607af4b3be5940", async() => {
                WriteLiteral("10");
            }
            );
            ...
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5cd89023b5301eb84d8ddd0cf328e7607af4b3be7115", async() => {
                WriteLiteral("20");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5cd89023b5301eb84d8ddd0cf328e7607af4b3be8290", async() => {
                WriteLiteral("30");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.End();
            WriteLiteral("\r\n                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5cd89023b5301eb84d8ddd0cf328e7607af4b3be9465", async() => {
                WriteLiteral("40");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5cd89023b5301eb84d8ddd0cf328e7607af4b3be10735", async() => {
    ...
    <div class=""modal-dialog  modal-lg"" role=""document"">
        <div class=""modal-content"">
            <div class=""modal-header"">
                <h4 class=""modal-title inline-block"" id=""exampleModalLabel""><i cla");
            WriteLiteral(@"ss='fa fa-list-alt' aria-hidden='true'></i>&nbsp;Cập nhật thông tin thể loại</h4>
        ...
        $(document).ready(function () { //Sau khi load xong html
            ...
            var $danhmuc = {
                init: function () {
                    ...
                    $danhmuc.SearchClick();
");
                WriteLiteral(@"                    $danhmuc.CreateOrUpdate();
                },
                $thisPage: $('.card'),
                OpenModal: function () {
                ...
                SearchClick: function () {
                    $danhmuc.$thisPage.find('.btnSearch').off('click').on('click', function () { $danhmuc.LoadDanhSach(1); }); //Sự kiện khi click vào ");
                WriteLiteral(@"nút có class btnSearch
                },
                LoadDanhSach: function (pageNum) {
                    ...
                    getResponse.then(function (response) { //getResponse thực hiện xong thì thực hiện funtion với tham số truyền vào là response - kết quả trả về của AjaxConfig.sendRequestToServer(""/Category/GetList"", ""GET"", dataSend);
                        if (response.header.msgType == 200) {
                            ...
                            ");
                WriteLiteral(@"    $danhmuc.$thisPage.find('table#TBLDANHSACH tbody').html(htmlContent);
                            ...
                            for (var i = 0; i < response.data.length; i++) {
                                ...
                                htmlContent += '<tr>' +
                                    ...
                                    '<td class=""text-center"">' +
                                        '<button type=""button"" class=""btn btn-secondary btn-sm btnEdit"" style=""margin-right: 5px;"" data-id=""' + $Item.categoryId + '""><i c");
                WriteLiteral(@"lass=""fa fa-pencil-square-o"">&nbsp;Sửa</i></a>' +
                            ...
                            /*$msgDialog.confirm(response.Header.MsgType, null, ");
                WriteLiteral(@"response.Body.Description, null, null, null);*/
                        }
                    }).catch(function (xhr) {
                ...
                CreateOrUpdate: function () {
                    $('#CreateOrUpdateModal .btnSave').off('click').on('click', function () {
                        ...
                        if (dataSend) {
                         ...
                         ");
                WriteLiteral(@"   getResponse.then(function (response) {
                                if (response.header.msgType == 200) {
                        ...
                        if (id > 0) {
                            ...
                            getResponse.then(function (response) {
                                if (response.header.msgType == 200) {
                                    alert(response.description);
                                    $danhmuc.LoadDanhSach(1);
                                    /*$msgDialog.confirm(response.header.msgType, null, res");
                WriteLiteral(@"ponse.description, null, null, null);*/
                                }
                                else {
                                    alert(response.description);
                                    /*$msgDialog.confirm(response.header.msgType, null, response.description, null, null, null);*/
